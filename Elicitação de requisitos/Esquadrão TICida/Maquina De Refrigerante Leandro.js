...
let bebidas = ["Coca Cola", " Guarana ", "  Fanta  ", "  Água   "];
let valoresBebidas = [ 6.00, 3.99, 3.50, 1.99];
let valorCedulas = [2.00, 5.00, 10.00, 20.00];
var valorASerPago = 0, escolhaPagamento = 0, somaPagamento = 0, troco = 0, somaPagamento = 0, escolhaBebida = 0;
...
do{
    ...
    escolhaBebida = ler("Qual a sua escolha? ");
